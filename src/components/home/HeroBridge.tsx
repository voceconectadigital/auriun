      ...
      <div className="pointer-events-none relative -translate-y-1/2 px-4 sm:px-8 lg:px-10">
        <div className="pointer-events-auto mx-auto w-full max-w-[1360px]">
          <div className="hero-bridge relative flex flex-col overflow-hidden rounded-[4px] border border-[rgba(7,26,45,0.1)] bg-[linear-gradient(180deg,#ffffff_0%,#f5f7f9_100%)] md:min-h-[104px] md:flex-row md:items-stretch">
            ...
            <div className="relative z-[1] flex min-w-0 flex-1 items-start gap-3 px-4 py-5 sm:items-center sm:gap-4 sm:px-8 md:py-0">
              <span className="mt-1 h-8 w-px shrink-0 bg-brand-orange sm:mt-0 sm:h-9" aria-hidden />
              <p className="min-w-0 text-pretty text-[0.9375rem] leading-[1.55] text-brand-graphite sm:text-[0.975rem]">
                Tecnologia, fornecimento e inteligência para manter a indústria em movimento.
              </p>
            </div>

            <div className="relative z-[1] flex shrink-0 items-center border-t border-[rgba(7,26,45,0.08)] bg-[#eef2f6] px-4 py-4 sm:px-8 md:w-[240px] md:border-l md:border-t-0 md:px-8 md:py-0 lg:w-[260px]">
              <p className="text-[12px] font-semibold uppercase tracking-[0.14em] text-brand-blue sm:tracking-[0.16em]">
